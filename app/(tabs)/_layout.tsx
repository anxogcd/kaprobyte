import { primaryWhite, secondaryColor } from '@/styles/colors';
...
export default function TabsLayout() {
  return (
    <SafeAreaProvider>
      <Tabs screenOptions={{ tabBarActiveTintColor: secondaryColor, tabBarStyle: { backgroundColor: primaryWhite } }}>
        ...
        <Tabs.Screen name="saved" options={{ title: "Gardado", headerShown: false, tabBarIcon: ({ color, size }) => <MaterialIcons name='save' size={size} color={color} /> }} />
